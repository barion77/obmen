...
async def get_text(message: types.Message,bot: Bot) -> None:
    if message.text == '💎 Мой профиль':
        ...
        fnt = ImageFont.truetype("/var/www/obmen/TGbot/Roboto-Bold.ttf", 50)
        fnt1 = ImageFont.truetype("/var/www/obmen/TGbot/Roboto-Bold.ttf", 40)
        fnt2 = ImageFont.truetype("/var/www/obmen/TGbot/Roboto-Regular.ttf", 18)
        fnt3 = ImageFont.truetype("/var/www/obmen/TGbot/Roboto-Regular.ttf", 21)
        fnt4= ImageFont.truetype("/var/www/obmen/TGbot/Roboto-Bold.ttf", 30)
        fnt5= ImageFont.truetype("/var/www/obmen/TGbot/Roboto-Bold.ttf", 30)
